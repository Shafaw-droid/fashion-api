...
class Brand(db.Model):
    ...
    favorite_brands = db.relationship('CustomerFavoriteBrands', back_populates='brand', cascade='all,delete-orphan')
...
class Clothing(db.Model):
    ...
    favorite_clothes = db.relationship('CustomerFavoriteClothing', back_populates='clothing',
...
class Outfit(db.Model):
    ...
    saved_outfits = db.relationship('CustomerSavedOutfits', back_populates='outfit', cascade='all,delete-orphan')
...
class CustomerStylingPreference(db.Model):
    ...
    preferred_color = db.Column(db.String(80))
...
class CustomerFavoriteBrands(db.Model):
    ...
    brand = db.relationship('Brand', back_populates='favorite_brands')
...
class CustomerSavedOutfits(db.Model):
    ...
    outfit = db.relationship('Outfit', back_populates='saved_outfits')
